...
def init(
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/spec-kitty.change[/] [bright_black](optional)[/bright_black] - Capture mid-implementation change requests as dependency-safe work packages (during [cyan]/spec-kitty.implement[/] or [cyan]/spec-kitty.review[/])"
    ]
